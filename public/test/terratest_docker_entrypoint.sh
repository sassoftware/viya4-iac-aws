...
# Verify the /viya4-iac-aws directory has been mounted by checking if
# the main.tf file exists
if [ ! -f "/viya4-iac-aws/main.tf" ]; then
  echo "Error: The /viya4-iac-aws directory has not been mounted"
  exit 1
fi
