...
| tags | Map of common tags to be placed on all AWS resources created by this script | map(string) | {} | Caller-defined tags only. Provide your organization's keys (for example, resourceowner and jiraticketid) in tfvars. |
