...
| jump_rwx_filestore_path | File store mount point on NFS server | string | "/viya-share" | This location cannot include "/mnt" as it's root location. This disk is ephemoral on the Ubuntu Servers being used for the Jump/NFS servers. |
